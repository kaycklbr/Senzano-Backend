...
class VrSyncController extends Controller
{
    public function generateXml(Request $request)
    {
        ...
        $header->addChild('Telephone', '67-99841-0528');
        ...
        foreach ($properties as $property) {
            ...
            $listing->addChild('DetailViewUrl', "https://senzanoempreendimentos.com.br/imovel/{$property->slug}");
            ...
            $contact->addChild('Website', 'https://senzanoempreendimentos.com.br');
